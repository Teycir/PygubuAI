...
from pygubuai.errors import (
    PygubuAIError, ProjectNotFoundError, InvalidProjectError,
    DependencyError, FileOperationError, ValidationError,
    RegistryError, UIParseError, GitError,
    validate_pygubu, handle_file_operation
)
...
class TestErrorRecovery(unittest.TestCase):
    ...
    def test_graceful_degradation(self):
        ...
        result = get_cached(Path("/nonexistent/file.ui"))
