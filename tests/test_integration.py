...
class TestEndToEndWorkflow(unittest.TestCase):
    ...
    def test_create_and_register_workflow(self):
        ...
        from pygubuai.registry import ProjectRegistry
        
        # Create project
        create_project("testapp", "simple app with button")
        ...
        # Register project
        registry = ProjectRegistry(str(self.registry_file))
        registry.add_project("testapp", str(project_dir))
        
        # Verify registration
        projects = registry.list_projects()
        self.assertEqual(len(projects), 1)
        self.assertEqual(projects[0]["name"], "testapp")
    ...
    def test_template_creation_workflow(self):
        ...
        create_from_template("loginapp", "login")
