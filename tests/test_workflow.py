...
from pygubuai.errors import ProjectNotFoundError  # noqa: E402
from pygubuai.workflow import get_file_hash, load_workflow, save_workflow, watch_project  # noqa: E402
...
class TestWorkflow(unittest.TestCase):
    ...
    def test_save_and_load_workflow(self):
        ...
        workflow_data = {"project": "testproj", "file_hashes": {"test.ui": "abc123"}, "last_sync": None, "history": []}
...
class TestWorkflowEdgeCases(unittest.TestCase):
    ...
    def test_workflow_preserves_existing_changes(self):
        ...
        initial = {
            "project": "proj",
            "file_hashes": {"a.ui": "v1"},
            "history": [{"timestamp": "2024-01-01", "action": "file_changed", "description": "File a.ui changed"}],
        }
        ...
        loaded["history"].append(
            {"timestamp": "2024-01-02", "action": "file_changed", "description": "File b.ui changed"}
        )
...
class TestMultiFileTracking(unittest.TestCase):
    ...
    def test_detects_specific_file_change(self):
        ...
        workflow = load_workflow(project_dir)
        workflow["file_hashes"] = {"a.ui": get_file_hash(file1), "b.ui": get_file_hash(file2)}
