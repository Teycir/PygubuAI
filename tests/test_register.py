...
from pygubuai.register import register_project, set_active, scan_directory  # noqa: E402
from pygubuai.registry import Registry  # noqa: E402
from pygubuai.errors import ProjectNotFoundError, InvalidProjectError  # noqa: E402
...
class TestRegister(unittest.TestCase):
    ...
    def test_register_project(self):
        ...
        self.assertEqual(pathlib.Path(projects["testproj"]).resolve(), project_dir.resolve())
